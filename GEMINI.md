...
Behavioral guidelines for Gemini Code Assist / Gemini CLI in this project. These reduce common LLM coding mistakes and enforce controlled AI-assisted development.
