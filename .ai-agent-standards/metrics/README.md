# Metrics & KPIs - Đo Lường Hiệu Suất

Theo dõi hiệu quả AI-Assisted development.

**Phần V.1 từ tài liệu gốc**

---

## 📊 KPI Definitions

### 1. Defect Rate (Tỷ lệ Lỗi)
- **Definition:** % của AI-Assisted code có bug sau merge
...
| File | Purpose |
|------|---------|
| [`kpi-definitions.md`](kpi-definitions.md) | Chi tiết từng KPI |
| [`tracking-template.csv`](tracking-template.csv) | Template log dữ liệu |
| [`sample-weekly-report.md`](sample-weekly-report.md) | Ví dụ báo cáo |
| [`dashboard-guide.md`](dashboard-guide.md) | Setup dashboard metrics |
