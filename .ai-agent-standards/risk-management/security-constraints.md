# Security Constraints - Lớp Nền Tiên Quyết

**Non-Negotiable Rules - Tuyệt đối không vi phạm**

Phần III.1 từ tài liệu gốc

---

## 🚫 Constraint 1: Zero-Trust for Secrets

**Rule:** KHÔNG bao giờ nhúng secrets vào code
...
**Rule:** ALL user input phải được validate trước sử dụng
...
**Rule:** ALL async/risky operations phải wrapped in try-catch
...
**Rule:** KHÔNG log passwords, tokens, PII
