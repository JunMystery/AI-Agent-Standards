...
Hệ thống quản lý rủi ro & escalation khi AI không hợp tác.
...
| File | Purpose |
|------|---------|
| [`security-constraints.md`](security-constraints.md) | Non-negotiable rules (bảo mật cốt lõi) |
| [`ai-failure-log-template.md`](ai-failure-log-template.md) | Template ghi nhận khi AI fail |
| [`escalation-workflow.md`](escalation-workflow.md) | Quy trình leo thang |
| [`cost-control-policy.md`](cost-control-policy.md) | Kiểm soát chi phí API |
| [`incident-response-plan.md`](incident-response-plan.md) | Kế hoạch ứng phó sự cố |
| [`mitigation-strategies.md`](mitigation-strategies.md) | Chiến lược giảm thiểu rủi ro |
...
**Risk Categories:**
1. **Security Risks** (lỗ hổng, data leak)
