...
**Bắt buộc sử dụng khi review code AI sinh ra.**
...
- [ ] **Self-Check Report** có & complete?
- [ ] **Requirements match?** Code làm được task yêu cầu?
- [ ] **Security:** No hardcoded secrets (API keys, tokens, passwords)?
- [ ] **Error Handling:** Try-catch có? Null checks?
- [ ] **Tests:** Unit tests có? Coverage >= 80%?
- [ ] **No Breaking Changes:** Backward compatible?

**Nếu tất cả PASS → Approve. Nếu 1 FAIL → Request changes.**

---

## 📋 Full Checklist (10-15 phút - detailed review)
...
**HÀNH VI BỊ CẤM - Reject immediately if found:**
